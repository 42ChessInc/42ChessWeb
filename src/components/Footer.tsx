export const Footer: React.FC = () => {
	return (
		<footer className="w-full py-10 shadow-sm bg-[var(--color-secondary)]">
			<div className="container mx-auto px-10 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-2">
